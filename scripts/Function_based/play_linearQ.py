...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    episode = 4900
    q_value_file = f"{Algorithm_name}_{episode}_{num_of_action}_{action_range[1]}_{discount}_{learning_rate}_{epsilon_decay}.json"
    ...
    obs_file_path = os.path.join("saved_obs", f"{Algorithm_name}_{num_of_action}_{action_range[1]}_{discount}_{learning_rate}_{epsilon_decay}.json")
    ...
    plt.title(f"{Algorithm_name}_{num_of_action}_{action_range[1]}_{discount}_{learning_rate}_{epsilon_decay}")
    plt.ylim(-0.4, 0.4)
    plt.legend()
    plt.grid(True)
    ...
    save_path = os.path.join(save_dir, f"{Algorithm_name}_{num_of_action}_{action_range[1]}_{discount}_{learning_rate}_{epsilon_decay}.png")
