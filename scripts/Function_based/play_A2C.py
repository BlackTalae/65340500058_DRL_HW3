...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    Algorithm_name = "A2C"  
    episode = 4900
    q_value_file = f"{Algorithm_name}_{episode}_{agent.num_of_action}_{agent.action_range[1]}_{agent.discount_factor}_{agent.learning_rate}_{agent.hidden}.pt"
    ...
    obs_file_path = os.path.join("saved_obs", f"{Algorithm_name}_{agent.num_of_action}_{agent.action_range[1]}_{agent.discount_factor}_{agent.learning_rate}_{agent.hidden}.json")
    ...
    plt.title(f"{Algorithm_name}_{agent.num_of_action}_{agent.action_range[1]}_{agent.discount_factor}_{agent.learning_rate}_{agent.hidden}")
    plt.ylim(-0.4, 0.4)
    plt.legend()
    plt.grid(True)
    ...
    save_path = os.path.join(save_dir, f"{Algorithm_name}_{agent.num_of_action}_{agent.action_range[1]}_{agent.discount_factor}_{agent.learning_rate}_{agent.hidden}.png")
